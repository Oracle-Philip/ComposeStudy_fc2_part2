...
import kr.co.fastcampus.part4plus.movieapp.BaseDialogFragment
import kr.co.fastcampus.part4plus.movieapp.R
import kr.co.fastcampus.part4plus.movieapp.ui.components.dialog.Default
import kr.co.fastcampus.part4plus.movieapp.ui.components.dialog.DialogPopup
...
class IMDBDialogFragment : BaseDialogFragment() {
    ...
    /**
     * <강의 메모> 24:21 ch19
     * private val args: IMDBDialogFragmentArgs by navArgs()에서
     * IMDBDialogFragmentArgs와 같이 Argument를 넣으려면
     * xml navGraph에 명시를 해줘야 한다.
     */
