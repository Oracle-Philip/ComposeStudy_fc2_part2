package kr.co.fastcampus.part4plus.movieapp.ui.components.dialog.components.title
...
import kr.co.fastcampus.part4plus.movieapp.ui.theme.h5Title
...
fun HeaderDialogTitle(title: DialogTitle.Header) {
    Column(
        ...
        /**
         * 복습
         * Column에 경우 위에서 아래로 배치된다.
         * 즉 Column과 같은 방향인게 Arrangement이다.
         */
